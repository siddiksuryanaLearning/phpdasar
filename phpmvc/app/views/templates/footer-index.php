                <h1 class="my-4 text-3xl md:text-5xl text-purple-800 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">Selamat Datang <?= $data['nama'] ?> </h1>
                ...
                <div class="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
                    <img src="../../../public/img/App Store.svg" class="h-12 pr-4 bounce-top-icons">
                    <img src="../../../public/img/Play Store.svg" class="h-12 bounce-top-icons">
                </div>
